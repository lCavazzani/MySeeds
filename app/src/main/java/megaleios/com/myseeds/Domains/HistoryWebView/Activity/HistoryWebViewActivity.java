package megaleios.com.myseeds.Domains.HistoryWebView.Activity;
...
//        webView.loadUrl("http://myseeds.api.megaleios.kinghost.net/Donation/SendDonation?token="+token);
        ...
        webView.loadUrl("http://myseeds.api.megaleios.kinghost.net/donatation/InfoDonatation?donatationId="+mID);
